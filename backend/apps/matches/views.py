...
from .models import Match, OPEN_FOR_USER_TURN_STATUSES, MatchStatus, Round, SenderType
from .serializers import MatchCreateSerializer, MatchDetailSerializer, MessageCreateSerializer
...
class MatchDetailView(generics.RetrieveAPIView):
    ...
    def get_queryset(self):
        return Match.objects.filter(user=self.request.user).prefetch_related("rounds__messages")
