...
#### [x] Epic 2.1: Continuous Integration & Deployment (The Pipe)
* [x] **Automated Multi-Stage CI Pipeline:** Configured GitHub Actions workflow triggering on Pull Requests to `dev`. It must orchestrate concurrent unit test execution (using Pytest-Django and Vitest) within isolated Docker runner environments.
